const siteConfig = {
  name: "Polymarket Alternative",
  tagline: "Polymarket Alternativen für Deutschland",
  description: "Polymarket Alternativen für Deutschland — Fundierte Analysen, Strategien und Tipps.",
  url: "https://polymarket-alternative.de",
  basePath: "",
  accentColor: "#7c3aed",
